...
def init_printouts(config, env, info, obs):
    if config.verbose:
        ...
        print('\tFinal target hover position [x, x_dot, y, y_dot, z, z_dot, phi, theta, psi, p, q, r]: ' + str(
            info['x_reference']))
        ...
        print('\tDistribution of the error on positions of gates and obstacles: ' + str(
